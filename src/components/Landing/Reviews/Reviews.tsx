...
const REVIEWS = [
  {
    ...
    company: "Preply",
    text: "ITLead допоміг мені структурувати знання з System Design. Питання про масштабування React-додатків були один в один як на моєму фінальному інтерв'ю.",
    initials: "ОШ"
  },
  {
  ...
  },
  {
    ...
    role: "Lead Developer",
    company: "Grammarly",
    text: "Ми часто використовуємо подібні кейси при наймі в нашу команду. ITLead готує саме до реальних викликів, а не просто до сухої теорії.",
    initials: "ЮБ"
  },
  {
    name: "Олег Симоненко",
